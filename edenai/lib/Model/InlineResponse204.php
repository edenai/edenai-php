 ...
 *
 * @category Class
 * @description launch ocr tables job response
 * @package  edenai
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse204 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'result' => '\edenai\Model\InlineResponse204Result1[]'
    ];
     ...
     * Gets result
     *
     * @return \edenai\Model\InlineResponse204Result1[]
     */
     ...
     * Sets result
     *
     * @param \edenai\Model\InlineResponse204Result1[] $result result
     *
     * @return $this
     */
